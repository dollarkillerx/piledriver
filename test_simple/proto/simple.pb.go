...
var file_simple_proto_rawDesc = []byte{
	...
	0x32, 0x39, 0x0a, 0x0c, 0x53, 0x69, 0x6d, 0x70, 0x6c, 0x65, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72,
	0x12, 0x29, 0x0a, 0x06, 0x53, 0x69, 0x6d, 0x70, 0x6c, 0x65, 0x12, 0x0e, 0x2e, 0x70, 0x72, 0x6f,
...
var file_simple_proto_depIdxs = []int32{
	0, // 0: proto.SimpleServer.Simple:input_type -> proto.Request
	1, // 1: proto.SimpleServer.Simple:output_type -> proto.Response
...
func (c *simpleServerClient) Simple(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/proto.SimpleServer/Simple", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedSimpleServerServer can be embedded to have forward compatible implementations.
type UnimplementedSimpleServerServer struct {
}

func (*UnimplementedSimpleServerServer) Simple(context.Context, *Request) (*Response, error) {
...
func _SimpleServer_Simple_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SimpleServerServer).Simple(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.SimpleServer/Simple",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SimpleServerServer).Simple(ctx, req.(*Request))
	}
	return interceptor(ctx, in, info, handler)
}

var _SimpleServer_serviceDesc = grpc.ServiceDesc{
	ServiceName: "proto.SimpleServer",
	HandlerType: (*SimpleServerServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Simple",
			Handler:    _SimpleServer_Simple_Handler,
		},
	},
