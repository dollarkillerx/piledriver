...
var file_stream_proto_rawDesc = []byte{
	...
	0x73, 0x67, 0x22, 0x1c, 0x0a, 0x08, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x10,
	0x0a, 0x03, 0x6d, 0x73, 0x67, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6d, 0x73, 0x67,
	0x32, 0x3d, 0x0a, 0x0c, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72,
	0x12, 0x2d, 0x0a, 0x06, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x12, 0x0e, 0x2e, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x2e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x0f, 0x2e, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x2e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x28, 0x01, 0x30, 0x01, 0x42,
...
var file_stream_proto_depIdxs = []int32{
	0, // 0: proto.StreamServer.Stream:input_type -> proto.Request
	1, // 1: proto.StreamServer.Stream:output_type -> proto.Response
...
type StreamServerClient interface {
	Stream(ctx context.Context, opts ...grpc.CallOption) (StreamServer_StreamClient, error)
}
...
func (c *streamServerClient) Stream(ctx context.Context, opts ...grpc.CallOption) (StreamServer_StreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &_StreamServer_serviceDesc.Streams[0], "/proto.StreamServer/Stream", opts...)
	if err != nil {
		return nil, err
	}
...
type StreamServer_StreamClient interface {
	Send(*Request) error
	Recv() (*Response, error)
	grpc.ClientStream
}
...
func (x *streamServerStreamClient) Send(m *Request) error {
	return x.ClientStream.SendMsg(m)
}

func (x *streamServerStreamClient) Recv() (*Response, error) {
	m := new(Response)
...
type StreamServerServer interface {
	Stream(StreamServer_StreamServer) error
}
...
func (*UnimplementedStreamServerServer) Stream(StreamServer_StreamServer) error {
...
func _StreamServer_Stream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(StreamServerServer).Stream(&streamServerStreamServer{stream})
}

type StreamServer_StreamServer interface {
	Send(*Response) error
	Recv() (*Request, error)
	grpc.ServerStream
}
...
func (x *streamServerStreamServer) Send(m *Response) error {
	return x.ServerStream.SendMsg(m)
}

func (x *streamServerStreamServer) Recv() (*Request, error) {
	m := new(Request)
...
var _StreamServer_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "Stream",
			Handler:       _StreamServer_Stream_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
